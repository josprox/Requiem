...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(firmware) => "Arranque actual: ${firmware}";
  ...
  static String m20(error) =>
      "No se pudieron enumerar las interfaces IPv4: ${error}";
  ...
  static String m28(error) => "ERROR KMS: ${error}";
  ...
  static String m34(ssid, result) => "Wi-Fi connected to ${ssid}. ${result}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "console_tooltip_copy": MessageLookupByLibrary.simpleMessage("Copiar logs"),
    ...
    "kms_product_windows_subsystem_for_linux":
        MessageLookupByLibrary.simpleMessage("Windows Subsystem for Linux"),
    ...
    "pkg_cat_gpu_compute": MessageLookupByLibrary.simpleMessage("GPU compute"),
